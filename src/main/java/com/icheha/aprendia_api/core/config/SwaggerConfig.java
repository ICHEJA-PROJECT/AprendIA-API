...
public class SwaggerConfig {
    ...
    private List<Tag> getOrderedTags() {
        return Arrays.asList(
                ...
                new Tag().name("4.01. Units").description("Gestión de unidades educativas"),
                new Tag().name("4.02. Topics").description("Gestión de temas"),
                new Tag().name("4.03. Topic Resources").description("Recursos asociados a temas"),
                new Tag().name("4.04. Topic Sequences").description("Secuencias de temas para rutas de aprendizaje"),
                new Tag().name("4.05. Resources").description("Gestión de recursos educativos"),
                new Tag().name("4.06. Type Layout").description("Tipos de layouts"),
                new Tag().name("4.07. Layouts").description("Gestión de layouts de presentación"),
                new Tag().name("4.08. Skills").description("Gestión de habilidades"),
                new Tag().name("4.09. Templates").description("Gestión de plantillas de ejercicios"),
                new Tag().name("4.10. Template Skills").description("Habilidades asociadas a plantillas"),
                new Tag().name("4.11. Type Instruction Media").description("Tipos de instrucciones y medios"),
                new Tag().name("4.12. Template Instruction Media").description("Instrucciones asociadas a plantillas"),
                new Tag().name("4.13. Exercises").description("Gestión de ejercicios individuales"),
